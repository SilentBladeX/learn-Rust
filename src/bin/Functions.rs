fn main() {
    println!("----------- Function Call and Return Demo -----------");
    function_demo();

    println!("----------- Rust is Expression-Based Language -----------");
    expression_demo();

    println!("----------- Using return in Loops and Functions -----------");
    return_from_function_demo();

    println!("----------- Using loop with break to return value -----------");
    loop_return_demo();
}
